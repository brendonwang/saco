        ...
        <section className="relative border-b border-outline-variant/30 bg-surface-container-low pb-16 pt-12 sm:pb-24 sm:pt-20 md:pb-32 md:pt-24">
          <div className="mx-auto max-w-6xl px-4 sm:px-8">
            ...
            <section
              ...
              className="relative mt-16 overflow-hidden border border-primary/30 bg-surface-container px-6 py-8 shadow-[0_0_28px_rgba(0,240,255,0.08)] sm:mt-20 sm:px-10 sm:py-12"
            >
